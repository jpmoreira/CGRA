...
//table 2 lid center Coordinates
double tb2_x= 12;
double tb2_y= 3.8;
double tb2_z= 8;

//table 1 lid center Coordinates
double tb1_x= 5;
double tb1_y= 3.8;
double tb1_z= 8;

//scalling on y for cylinder
double cyl_y_scale = 2;
...
void LightingScene::display()
{
	...
	//Cylinder 1
	glPushMatrix();
	//Move to the top of second Table, y= cyl_y_scale * half of cyl height
	glTranslated(tb1_x, tb1_y + cyl_y_scale*0.5, tb1_z);
	glScaled(1, cyl_y_scale, 1);
	cil->draw(CENTERED_NORMALS);
	glPopMatrix();

	//Cylinder 2
	glPushMatrix();
	//Move to the top of second Table, y= cyl_y_scale * half of cyl height
	glTranslated(tb2_x, tb2_y + cyl_y_scale*0.5, tb2_z);
	glScaled(1, cyl_y_scale, 1);
	cil->draw(VERTEX_NORMALS);
	glPopMatrix();
